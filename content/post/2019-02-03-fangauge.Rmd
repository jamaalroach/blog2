---
title: '#FanGauge | Twitter Sentiment Analysis'
author: ''
date: '2019-01-22'   
...
tags:
  ...
  - Football
  - Twitter
summary: Ok, so this is not the football related content I had in mind **BUT** this analysis of Donald Trump's tweets on the Variance Explained blog got me thinking about ways to apply sentiment analysis to tweets.
draft: yes
image: img/mci.jpg
...
The data manipulation and visualisation were done using [R](https://www.r-project.org/) and you can find the source data and code [here]() and [here]().
...
The analysis was done by [Microsoft Cognitive Services Text Analytics APIs](), which uses a  [machine learning]() classification algorithm to generate a sentiment score between 0 and 1. Scores closer to 1 indicate positive sentiment, while scores closer to 0 indicate negative sentiment. I then converted the scores to percentages.
